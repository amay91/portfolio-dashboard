...
// arrow-keying) a bar shows "{year}, Amount: ₹Xl" in a tooltip. Interaction
// scaffolding lives in InteractiveChartFrame (review item C2) — this
// component owns only the bar/grid geometry and tooltip content.
export function CapitalChart({ series }: { series: Series }) {
  ...
  return (
    <InteractiveChartFrame ariaLabel="Net capital added by year. Focus the chart and use the left and right arrow keys to inspect a year." n={bars.length}>
      {(hover, setHover) => {
