...
export function SortableTable<T>({ id, columns, data, totalCells, defaultSort, className }: SortableTableProps<T>) {
  ...
  return (
    // Wide tables (many numeric columns, unwrapped scheme names) can exceed
    // a narrow viewport — this contains that overflow to the table itself
    // instead of the whole page scrolling sideways (mobile optimization M1).
